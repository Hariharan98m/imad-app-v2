...
function f(data){
    ...
    var menu='<h2>'+data.menu.cuisine+"</h2> <div style='font-size=12px;font-color=crimson' >Start: </div>"+data.menu.start+"<br> <div style='font-size=12px;font-color=crimson' >End: </div>"+data.menu.end+'';
    var list='<ul>';
